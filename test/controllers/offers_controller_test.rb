...
class OffersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create offer" do
    assert_difference('Offer.count') do
      post offers_url, params: { offer: { home_id: @offer.home_id, user_id: @offer.user_id } }
    end
  ...
  test "should update offer" do
    patch offer_url(@offer), params: { offer: { home_id: @offer.home_id, user_id: @offer.user_id } }
