...
(function() {
  ...
  $(document).ready(function() {
    var slider;
    $('#filterrific_button').on("click", function(e) {
      e.preventDefault();
      $("#filterrific-no-ajax-auto-submit").trigger("submit");
      return $("#filterrific-no-ajax-auto-submit-header").trigger("submit");
    });
    slider = $('#price_slider').slider({
      range: true,
      min: parseFloat($('#hidden').attr('total-min')),
      max: parseFloat($('#hidden').attr('total-max')),
      values: [$('#hidden').attr('data-min'), $('#hidden').attr('data-max')],
  ...
  RichMarkerBuilder = (function(superClass) {
    ...
    RichMarkerBuilder.prototype.rich_marker_options = function() {
      ...
      marker.innerHTML = this.args.address;
      return {
        content: marker
      };
    };
    ...
    RichMarkerBuilder.prototype.create_infowindow = function() {
      var boxText;
      if (!_.isNumber(this.args.infowindow)) {
        return null;
      }
